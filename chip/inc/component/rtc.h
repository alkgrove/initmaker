/**
 * @note This file is modified from the Atmel ASF4 hri library
 * by Alkgrove 2018
**/
/**
 * \file
...
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
       RTCMODE0_t                MODE0;       /**< \brief Offset: 0x00 32-bit Counter with Single 32-bit Compare */
       RTCMODE1_t                MODE1;       /**< \brief Offset: 0x00 16-bit Counter with Two 16-bit Compares */
       RTCMODE2_t                MODE2;       /**< \brief Offset: 0x00 Clock/Calendar with Alarm */
} RTC_t;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
