...
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
       SERCOMI2CM_t              I2CM;        /**< \brief Offset: 0x00 I2C Master Mode */
       SERCOMI2CS_t              I2CS;        /**< \brief Offset: 0x00 I2C Slave Mode */
       SERCOMSPI_t               SPI;         /**< \brief Offset: 0x00 SPI Mode */
       SERCOMUSART_t             USART;       /**< \brief Offset: 0x00 USART Mode */
} SERCOM_t;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
