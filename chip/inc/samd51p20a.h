...
#else
#define AC                ((AC_t     *)0x42002000UL) /**< \brief (AC) APB Base Address */
#define AC_INST_NUM       1                          /**< \brief (AC) Number of instances */
#define AC_INSTS          { AC }                     /**< \brief (AC) Instances List */

#define ADC0              ((ADC_t    *)0x43001C00UL) /**< \brief (ADC0) APB Base Address */
#define ADC1              ((ADC_t    *)0x43002000UL) /**< \brief (ADC1) APB Base Address */
#define ADC_INST_NUM      2                          /**< \brief (ADC) Number of instances */
#define ADC_INSTS         { ADC0, ADC1 }             /**< \brief (ADC) Instances List */

#define AES               ((AES_t    *)0x42002400UL) /**< \brief (AES) APB Base Address */
#define AES_INST_NUM      1                          /**< \brief (AES) Number of instances */
#define AES_INSTS         { AES }                    /**< \brief (AES) Instances List */

#define CCL               ((CCL_t    *)0x42003800UL) /**< \brief (CCL) APB Base Address */
#define CCL_INST_NUM      1                          /**< \brief (CCL) Number of instances */
#define CCL_INSTS         { CCL }                    /**< \brief (CCL) Instances List */

#define CMCC              ((CMCC_t   *)0x41006000UL) /**< \brief (CMCC) APB Base Address */
...
#define DAC               ((DAC_t    *)0x43002400UL) /**< \brief (DAC) APB Base Address */
#define DAC_INST_NUM      1                          /**< \brief (DAC) Number of instances */
#define DAC_INSTS         { DAC }                    /**< \brief (DAC) Instances List */

#define DMAC              ((DMAC_t   *)0x4100A000UL) /**< \brief (DMAC) APB Base Address */
#define DMAC_INST_NUM     1                          /**< \brief (DMAC) Number of instances */
#define DMAC_INSTS        { DMAC }                   /**< \brief (DMAC) Instances List */

#define DSU               ((DSU_t    *)0x41002000UL) /**< \brief (DSU) APB Base Address */
#define DSU_INST_NUM      1                          /**< \brief (DSU) Number of instances */
#define DSU_INSTS         { DSU }                    /**< \brief (DSU) Instances List */

#define EIC               ((EIC_t    *)0x40002800UL) /**< \brief (EIC) APB Base Address */
#define EIC_INST_NUM      1                          /**< \brief (EIC) Number of instances */
#define EIC_INSTS         { EIC }                    /**< \brief (EIC) Instances List */

#define EVSYS             ((EVSYS_t  *)0x4100E000UL) /**< \brief (EVSYS) APB Base Address */
#define EVSYS_INST_NUM    1                          /**< \brief (EVSYS) Number of instances */
#define EVSYS_INSTS       { EVSYS }                  /**< \brief (EVSYS) Instances List */

#define FREQM             ((FREQM_t  *)0x40002C00UL) /**< \brief (FREQM) APB Base Address */
#define FREQM_INST_NUM    1                          /**< \brief (FREQM) Number of instances */
#define FREQM_INSTS       { FREQM }                  /**< \brief (FREQM) Instances List */

#define GCLK              ((GCLK_t   *)0x40001C00UL) /**< \brief (GCLK) APB Base Address */
#define GCLK_INST_NUM     1                          /**< \brief (GCLK) Number of instances */
#define GCLK_INSTS        { GCLK }                   /**< \brief (GCLK) Instances List */

#define HMATRIX           ((HMATRIXB_t *)0x4100C000UL) /**< \brief (HMATRIX) APB Base Address */
#define HMATRIXB_INST_NUM 1                          /**< \brief (HMATRIXB) Number of instances */
#define HMATRIXB_INSTS    { HMATRIX }                /**< \brief (HMATRIXB) Instances List */

#define ICM               ((ICM_t    *)0x42002C00UL) /**< \brief (ICM) APB Base Address */
#define ICM_INST_NUM      1                          /**< \brief (ICM) Number of instances */
#define ICM_INSTS         { ICM }                    /**< \brief (ICM) Instances List */

#define I2S               ((I2S_t      *)0x43002800UL) /**< \brief (I2S) APB Base Address */
#define I2S_INST_NUM      1                          /**< \brief (I2S) Number of instances */
#define I2S_INSTS         { I2S }                    /**< \brief (I2S) Instances List */

#define MCLK              ((MCLK_t   *)0x40000800UL) /**< \brief (MCLK) APB Base Address */
#define MCLK_INST_NUM     1                          /**< \brief (MCLK) Number of instances */
#define MCLK_INSTS        { MCLK }                   /**< \brief (MCLK) Instances List */

#define NVMCTRL           ((NVMCTRL_t*)0x41004000UL) /**< \brief (NVMCTRL) APB Base Address */
...
#define OSCCTRL           ((OSCCTRL_t*)0x40001000UL) /**< \brief (OSCCTRL) APB Base Address */
#define OSCCTRL_INST_NUM  1                          /**< \brief (OSCCTRL) Number of instances */
#define OSCCTRL_INSTS     { OSCCTRL }                /**< \brief (OSCCTRL) Instances List */

#define OSC32KCTRL        ((OSC32KCTRL_t *)0x40001400UL) /**< \brief (OSC32KCTRL) APB Base Address */
...
#define QSPI              ((QSPI_t   *)0x42003400UL) /**< \brief (QSPI) APB Base Address */
...
#define RAMECC            ((RAMECC_t *)0x41020000UL) /**< \brief (RAMECC) APB Base Address */
#define RAMECC_INST_NUM   1                          /**< \brief (RAMECC) Number of instances */
#define RAMECC_INSTS      { RAMECC }                 /**< \brief (RAMECC) Instances List */

#define RSTC              ((RSTC_t   *)0x40000C00UL) /**< \brief (RSTC) APB Base Address */
#define RSTC_INST_NUM     1                          /**< \brief (RSTC) Number of instances */
#define RSTC_INSTS        { RSTC }                   /**< \brief (RSTC) Instances List */

#define RTC               ((RTC_t    *)0x40002400UL) /**< \brief (RTC) APB Base Address */
#define RTC_INST_NUM      1                          /**< \brief (RTC) Number of instances */
#define RTC_INSTS         { RTC }                    /**< \brief (RTC) Instances List */

#define SDHC0             ((SDHC_t   *)0x45000000UL) /**< \brief (SDHC0) AHB Base Address */
#define SDHC1             ((SDHC_t   *)0x46000000UL) /**< \brief (SDHC1) AHB Base Address */
#define SDHC_INST_NUM     2                          /**< \brief (SDHC) Number of instances */
#define SDHC_INSTS        { SDHC0, SDHC1 }           /**< \brief (SDHC) Instances List */

#define SERCOM0           ((SERCOM_t *)0x40003000UL) /**< \brief (SERCOM0) APB Base Address */
#define SERCOM1           ((SERCOM_t *)0x40003400UL) /**< \brief (SERCOM1) APB Base Address */
#define SERCOM2           ((SERCOM_t *)0x41012000UL) /**< \brief (SERCOM2) APB Base Address */
#define SERCOM3           ((SERCOM_t *)0x41014000UL) /**< \brief (SERCOM3) APB Base Address */
#define SERCOM4           ((SERCOM_t *)0x43000000UL) /**< \brief (SERCOM4) APB Base Address */
#define SERCOM5           ((SERCOM_t *)0x43000400UL) /**< \brief (SERCOM5) APB Base Address */
#define SERCOM6           ((SERCOM_t *)0x43000800UL) /**< \brief (SERCOM6) APB Base Address */
#define SERCOM7           ((SERCOM_t *)0x43000C00UL) /**< \brief (SERCOM7) APB Base Address */
...
#define SUPC              ((SUPC_t   *)0x40001800UL) /**< \brief (SUPC) APB Base Address */
#define SUPC_INST_NUM     1                          /**< \brief (SUPC) Number of instances */
#define SUPC_INSTS        { SUPC }                   /**< \brief (SUPC) Instances List */

#define TAL               ((TAL_t    *)0x4101E000UL) /**< \brief (TAL) APB Base Address */
#define TAL_INST_NUM      1                          /**< \brief (TAL) Number of instances */
#define TAL_INSTS         { TAL }                    /**< \brief (TAL) Instances List */

#define TC0               ((TC_t     *)0x40003800UL) /**< \brief (TC0) APB Base Address */
#define TC1               ((TC_t     *)0x40003C00UL) /**< \brief (TC1) APB Base Address */
#define TC2               ((TC_t     *)0x4101A000UL) /**< \brief (TC2) APB Base Address */
#define TC3               ((TC_t     *)0x4101C000UL) /**< \brief (TC3) APB Base Address */
#define TC4               ((TC_t     *)0x42001400UL) /**< \brief (TC4) APB Base Address */
#define TC5               ((TC_t     *)0x42001800UL) /**< \brief (TC5) APB Base Address */
#define TC6               ((TC_t     *)0x43001400UL) /**< \brief (TC6) APB Base Address */
#define TC7               ((TC_t     *)0x43001800UL) /**< \brief (TC7) APB Base Address */
#define TC_INST_NUM       8                          /**< \brief (TC) Number of instances */
#define TC_INSTS          { TC0, TC1, TC2, TC3, TC4, TC5, TC6, TC7 } /**< \brief (TC) Instances List */

#define TCC0              ((TCC_t    *)0x41016000UL) /**< \brief (TCC0) APB Base Address */
#define TCC1              ((TCC_t    *)0x41018000UL) /**< \brief (TCC1) APB Base Address */
#define TCC2              ((TCC_t    *)0x42000C00UL) /**< \brief (TCC2) APB Base Address */
#define TCC3              ((TCC_t    *)0x42001000UL) /**< \brief (TCC3) APB Base Address */
#define TCC4              ((TCC_t    *)0x43001000UL) /**< \brief (TCC4) APB Base Address */
#define TCC_INST_NUM      5                          /**< \brief (TCC) Number of instances */
#define TCC_INSTS         { TCC0, TCC1, TCC2, TCC3, TCC4 } /**< \brief (TCC) Instances List */

#define TRNG              ((TRNG_t   *)0x42002800UL) /**< \brief (TRNG) APB Base Address */
#define TRNG_INST_NUM     1                          /**< \brief (TRNG) Number of instances */
#define TRNG_INSTS        { TRNG }                   /**< \brief (TRNG) Instances List */

#define USB               ((USB_t    *)0x41000000UL) /**< \brief (USB) APB Base Address */
#define USB_INST_NUM      1                          /**< \brief (USB) Number of instances */
#define USB_INSTS         { USB }                    /**< \brief (USB) Instances List */

#define WDT               ((WDT_t    *)0x40002000UL) /**< \brief (WDT) APB Base Address */
