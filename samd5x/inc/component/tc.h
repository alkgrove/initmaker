...
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
       TCCOUNT8_t                COUNT8;      /**< \brief Offset: 0x00 8-bit Counter Mode */
       TCCOUNT16_t                 COUNT16;     /**< \brief Offset: 0x00 16-bit Counter Mode */
       TCCOUNT32_t                 COUNT32;     /**< \brief Offset: 0x00 32-bit Counter Mode */
} TC_t;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
